...
**Las letras que van encima del violeta son blancas.** El mismo 2026-09-04 se probó un dorado (`#FCD34D`) durante unas horas —contraste 4,9:1 sobre el violeta, contra 7,1:1 del blanco— y el cliente lo vio y pidió sacarlo: no le convenció. Volvió a blanco el mismo día. No hay ningún dorado en la aplicación.
